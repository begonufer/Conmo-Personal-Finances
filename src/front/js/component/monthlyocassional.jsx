...
export const pieData = {
    ...
    const pieDataDetalle = {
        labels: ['Tipo ingreso 1', 'Tipo ingreso 2', 'Tipo ingreso 3', 'Tipo ingreso 4'],
        datasets: [
            {
                label: "€",
            ...
            <div className="w-100 h-100">
                ...
                <div className="row pb-5">
                    ...
                    <div className="col-4 mx-5 text-center">
                        <div className="row mt-5">
                            <h3>Gastos</h3>
                            <p>Dónde se ocupa cada parte de los gastos variables.</p>
                ...
                <div className="row justify-content-center align-items-center py-5 mx-5">
                    <div className="col text-center">
                        <h3>Gastos</h3>
                        <p>Qué días tenemos cada gasto variable.</p>
