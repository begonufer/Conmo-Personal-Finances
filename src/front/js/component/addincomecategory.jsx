...
export const AddIncomeCategoryModal = () => {
    ...
    const addCategory = async () => {
        await actions.setIncomeCategory(value);
    ...
    return (
        <>
            <div className="modal fade" id="incomeCategoryModal" tabIndex="-1" aria-labelledby="incomeCategoryModalLabel" aria-hidden="true">
