            ...
            <div className="row mx-1 gap-2">
                ...
                <div className="col-md col-12">
                    <div className="row text-white usage-part-right rounded-pill fw-normal fs-5">
                        ...
                        <div className="col mobile-text py-3 fw-normal"> {selectedMonthUsageAmount.toFixed(2)}€</div>
                        <div className="col mobile-text py-3 fw-normal">{calculatePercentage(selectedMonthUsageAmount, selectedMonthAmount)}%</div>
                    </div>
                </div>
                <div className="col-md col-12 p-0">
