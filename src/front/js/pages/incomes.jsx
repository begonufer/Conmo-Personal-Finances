...
import { AnualIncomePie } from "../component/graphics/incomeanualpie.jsx";
import { MonthlyIncomeBar } from "../component/graphics/incomemonthlybar.jsx";
import { AnualIncomeBar } from "../component/graphics/incomeanualbar.jsx";
        ...
        <>
            ...
            <div className="d-block w-100 h-100 align-items-center">
                        ...
                        <div id="tableCarousel" className="carousel carousel-dark slide" data-bs-ride="carousel" data-bs-interval="false">
                            <div className="carousel-inner">
                                ...
                                <div className="carousel-item pe-5 text-center">
                                    <AnualIncomeTable selectedMonth={selectedMonth} selectedMonthIndex={selectedMonthIndex} selectedYear={selectedYear} previousMonth={previousMonth} />
                                </div>
                            </div>
                            <button
                ...
                <div className="row justify-content-center pb-5 mx-5">
                    ...
                    <div className="col-4 text-center my-3 p-4">
                        <AnualIncomePie selectedYear={selectedYear}/> 
                    </div>
                    <div className="col-7 ms-5 align-self-center my-3">
                        <AnualIncomeBar selectedYear={selectedYear}/>
                    </div>
                </div>
